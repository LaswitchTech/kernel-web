...
$router->get('/notes', 'Plugins\Notes\NotesController@index', ['WebAuth']);

// Create a note.
$router->post('/notes', 'Plugins\Notes\NotesController@add', ['WebAuth']);

// Show a single note (JSON API).
$router->get('/notes/{id}', 'Plugins\Notes\NotesController@show', ['WebAuth']);

// Delete a note.
$router->delete('/notes/{id}/delete', 'Plugins\Notes\NotesController@delete', ['WebAuth']);
