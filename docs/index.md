...
- [Installation Guide](developer/installation/install.md)
- [Architecture](developer/kernel/architecture.md)
- [Kernel Status](developer/kernel/kernel-status.md)
- [Service Design](developer/kernel/services.md)
...
- [Dashboard](user/kernel/dashboard.md)
- [Admin Panel](user/kernel/admin.md)
- [Configuration](user/installation/config.md)
- [Chat Plugin](user/plugins/chat.md)
- [Tasks Plugin](user/plugins/tasks.md)
