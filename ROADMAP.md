...
| Testing | Partially implemented | Zero-dependency test framework with 9 suites (416 assertions) — router, plugin, migration, auth, mailer, remember_me, forgot_password, email_verification, registration. CRUD coverage for users/groups/permissions/tokens complete. Mailer foundation implemented. See docs/developer/testing.md |
