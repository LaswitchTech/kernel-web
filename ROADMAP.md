...
| Testing | Partially implemented | Zero-dependency test framework with 13 suites (593 assertions) — router, plugin, migration, auth, mailer, remember_me, forgot_password, email_verification, registration, two_factor, organization, organization_runtime, smtp. CRUD coverage for users/groups/permissions/tokens complete. Mailer + SMTP foundation implemented. See docs/developer/testing.md |
