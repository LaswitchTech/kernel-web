...
(function () {
    ...
    (function () {
        var loaded = false;
        var tabEl = document.getElementById('tab-tokens');
        if (!tabEl) return;
        tabEl.addEventListener('shown.bs.tab', function () {
            ...
            if (!listLoading || !listEmpty || !listEl) return;
            ...
            if (createForm && nameInput) {
                createForm.addEventListener('submit', function (e) {
                    ...
                    var label = btn ? btn.querySelector('.create-label') : null;
                    var loader = btn ? btn.querySelector('.loading-label') : null;
                    ...
                    .then(function (data) {
                        if (data.token && valueEl) {
                            valueEl.textContent = data.token;
                            if (createdEl) createdEl.classList.remove('d-none');
                        }
                        if (data.record) loadTokens();
                    })
                    .catch(function (err) {
                        if (createError) {
